...
SnailBait.prototype = {
   ...
   */
   ...
   toggleSlowMotion: function () {
      console.log('s key pressed, time rate was : ' + this.timeRate);
      if(this.timeRate == 0.1){
         console.log('time rate set to normal');
         this.timeRate = 1.0;
      }
      else
      {
         console.log('set time rate to slow motion');
         this.timeRate = 0.1;
      }
   },
